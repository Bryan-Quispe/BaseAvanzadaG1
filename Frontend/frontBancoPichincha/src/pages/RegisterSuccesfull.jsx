    ...
    return (
        ...
        >
            <div className="bg-white p-10 rounded-lg shadow-lg text-center w-96 border border-gray-200">
                <h1 className="text-3xl text-center text-blue-900">¡Registro Completado Exitosamente!</h1>
                <i className="bi bi-check-square text-[50px] text-green-700 font-bold"></i>
                <button onClick={login} className="w-full bg-yellow-400 text-blue-900 font-bold py-2 rounded-md hover:bg-yellow-500 transition cursor-pointer">Ir a Iniciar Sesión</button>
            </div>
